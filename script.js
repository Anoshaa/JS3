...
// Array index batayga
let student =["anosha" , "kainat" , "laiba"];
...
const lastElement= student.pop();
console.log(student);
console.log(lastElement);
// Array shift first name bhar ajayga
const firstElement =student.shift();
console.log(student);
console.log(firstElement);
// Array unshift first name hata kar nabiha likh jayga
student.unshift("nabiha");
console.log(student);
// Array toString
console.log(student);
